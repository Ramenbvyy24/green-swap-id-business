      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Button className="bg-white text-primary hover:bg-white/90 text-lg px-12 py-6 group">
              Download App Now
              <Smartphone className="w-5 h-5 ml-2 group-hover:scale-110 transition-transform" />
            </Button>
            <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-primary text-lg px-12 py-6">
              Schedule Pickup
            </Button>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white/90">
            ...
            <div>
              ...
              <div className="text-2xl font-bold">hello@ecopoints.id</div>
            </div>
          </div>
